...
export const accounts = pgTable(
  ...
  (t) => [
    ...
    uniqueIndex("idx_accounts_company_account_number").on(t.companyId, t.accountNumber, t.accountType),
  ]
);
...
export const tripletexSyncConfigs = pgTable(
  "tripletex_sync_configs",
  {
    ...
    clientId: uuid("client_id")
      ...
      .references(() => clients.id, { onDelete: "cascade" }),
    tenantId: text("tenant_id").notNull(),
    tripletexCompanyId: bigint("tripletex_company_id", { mode: "number" }).notNull(),
    set1TripletexAccountId: bigint("set1_tripletex_account_id", { mode: "number" }),
    set2TripletexAccountId: bigint("set2_tripletex_account_id", { mode: "number" }),
